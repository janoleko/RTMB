...
* exotic probability distributions may be found in [`RTMBdist`](https://janoleko.github.io/RTMBdist/). For other available implementations, anything that descends into C(++)/Fortran code will probably fail.
If a distribution is not already available, you need to implement it yourself (and may want to issue a pull request to [`RTMBdist`](https://github.com/janoleko/RTMBdist)).
